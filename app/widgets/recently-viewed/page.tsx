...
export default function RecentlyViewedPage() {
  ...
  async function loadWidget() {
    try {
      const res = await fetch("/api/widgets/recently-viewed")
  ...
  return (
    <main style={styles.main}>
      ...
      <div style={styles.card}>
        <p style={styles.muted}>Affiche les produits récemment consultés par le visiteur.</p>
        ...
        >
          {loading ? "Chargement..." : active ? "Désactiver Recently Viewed" : "Activer Recently Viewed"}
        </button>
      </div>
    </main>
  )
