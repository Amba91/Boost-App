...
export default function TrustBadgesPage() {
  ...
  async function loadWidget() {
    try {
      const res = await fetch("/api/widgets/trust-badges")
  ...
  return (
    <main style={styles.main}>
      ...
      <h1 style={styles.title}>Trust Badges</h1>

      <div style={styles.card}>
        <p style={styles.muted}>Badges de confiance pour rassurer les clients.</p>
        ...
        >
          {loading ? "Chargement..." : active ? "Désactiver Trust Badges" : "Activer Trust Badges"}
        </button>
      </div>
    </main>
  )
