...
export default function RelatedProductsPage() {
  ...
  async function loadWidget() {
    try {
      const res = await fetch("/api/widgets/related-products")
  ...
  return (
    <main style={styles.main}>
      ...
      <h1 style={styles.title}>Related Products</h1>

      <div style={styles.card}>
        <p style={styles.muted}>Recommandations de produits similaires pour augmenter le panier moyen.</p>
        ...
        >
          {loading ? "Chargement..." : active ? "Désactiver Related Products" : "Activer Related Products"}
        </button>
      </div>
    </main>
  )
